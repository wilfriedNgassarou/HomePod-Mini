  ...
  return (
    <div className={`hero  ${animationState}`}>
      ...
      <div className={`homepod-container ${iconShowed}`}>
        <div>
          <img src="/assets/homepod/hp_white.webp" alt="Home Pod White" />
        </div>
        <div>
          <img src="/assets/homepod/hp_blue.webp" alt="Home Pod Blue" />
        </div>
        <div>
          <img src="/assets/homepod/hp_yellow.webp" alt="Home Pod Yellow" />
        </div>
        <div className="black">
          <img src="assets/homepod/hp_black.webp" alt="Home Pod Black" />
        </div>
        <div ref={homePodRef} onTransitionEnd={handleTransitionEnd} className="orange">
          <img src="/assets/homepod/hp_orange.webp" alt="Home Pod Orange" />
        </div>
        ...
        <span className="homepod-text">
          <img src="/assets/mini.webp" alt="Mini" />
        </span>
      </div>
    </div>
  )
